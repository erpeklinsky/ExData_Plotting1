...
plot(subsetData$Sub_metering_1~subsetData$DateTime, type="l", col = "black", 
     ylab="Energy sub metering", xlab="")

points(subsetData$Sub_metering_2~subsetData$DateTime, type="l", col = "red")

points(subsetData$Sub_metering_3~subsetData$DateTime, type="l", col = "blue")
